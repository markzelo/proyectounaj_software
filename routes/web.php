...
Route::get('/carritodetalle', 'SaleProductController@index');
...
Route::get('/PdfDemo', 'PdfDemoController@index');
Route::post('/PdfDemo', 'PdfDemoController@index');
Route::get('PdfDemo/HtmlToPDF', 'PdfDemoController@htmlToPDF');
Route::post('PdfDemo/HtmlToPDF', 'PdfDemoController@htmlToPDF');
